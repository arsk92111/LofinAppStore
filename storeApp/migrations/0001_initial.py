# Generated by Django 5.0.6 on 2025-09-20 08:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db_link', models.FileField(max_length=500, upload_to='media/AppsFile/')),
                ('db_photoApp', models.ImageField(blank=True, max_length=255, upload_to='media/AppsImage/')),
                ('db_images_list1', models.FileField(blank=True, upload_to='media/ImageList/')),
                ('db_images_list2', models.FileField(blank=True, upload_to='media/ImageList/')),
                ('db_images_list3', models.FileField(blank=True, upload_to='media/ImageList/')),
                ('db_images_list4', models.FileField(blank=True, upload_to='media/ImageList/')),
                ('db_create_Date', models.DateField(auto_now_add=True)),
                ('db_country', models.CharField(max_length=255)),
                ('db_comment', models.ManyToManyField(related_name='db_comment', to=settings.AUTH_USER_MODEL)),
                ('db_like', models.ManyToManyField(related_name='db_like', to=settings.AUTH_USER_MODEL)),
                ('db_paid', models.ManyToManyField(related_name='db_paid', to=settings.AUTH_USER_MODEL)),
                ('db_wishlist', models.ManyToManyField(related_name='db_wishlist', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='db_Profile',
            fields=[
                ...
                ('db_photo', models.ImageField(blank=True, max_length=255, upload_to='media/Profile/')),
